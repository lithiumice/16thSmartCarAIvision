...
/* 线程栈相关配置 */
#define PKG_EASYBLINK_THREAD_PRIORITY RT_MAIN_THREAD_PRIORITY
// #define PKG_EASYBLINK_THREAD_PRIORITY (RT_THREAD_PRIORITY_MAX - 4)
...
#define PKG_EASYBLINK_WAIT_MUTEX_TICK 0
...
#define __EASYBLINK_MS_TO_TICK(__MS__) ((__MS__)*RT_TICK_PER_SECOND / 1000U)
    ...
    extern ebled_t easyblink_init_led(PIN_enum rt_pin, uint8 active_level);
