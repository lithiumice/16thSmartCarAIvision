/*
#include <packages/flex_blink/easyblink.h>
...
static struct easyblink_data eb_leds[PKG_EASYBLINK_MAX_LED_NUMS];
 ...
 ***************************************************************************************************/
ebled_t easyblink_init_led(PIN_enum led_pin, uint8 active_level)
{
    int i;
    ebled_t led = RT_NULL;
