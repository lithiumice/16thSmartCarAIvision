...
typedef enum //枚举端口方向
{
    ...
    A5,
    A6,
    A7, //RT1064 没有GPIO0端口 这里仅仅用于保留占位
    A8,
    A9,
    A10,
    A11,
    ...
    A13,
    A14,
    A15, //RT1064 没有GPIO0端口 这里仅仅用于保留占位
    A16,
    A17,
    A18,
    A19,
    ...
    A21,
    A22,
    A23, //RT1064 没有GPIO0端口 这里仅仅用于保留占位
    A24,
    A25,
    A26,
    A27,
    ...
    A29,
    A30,
    A31, //RT1064 没有GPIO0端口 这里仅仅用于保留占位
    ...
    E5,
    E6,
    E7, //RT1064 没有GPIO4端口 这里仅仅用于保留占位
    E8,
    E9,
    E10,
    E11,
    ...
    E13,
    E14,
    E15, //RT1064 没有GPIO4端口 这里仅仅用于保留占位
    E16,
    E17,
    E18,
    E19,
    ...
    E21,
    E22,
    E23, //RT1064 没有GPIO4端口 这里仅仅用于保留占位
    E24,
    E25,
    E26,
    E27,
    ...
    E29,
    E30,
    E31, //RT1064 没有GPIO4端口 这里仅仅用于保留占位
    ...
    G13,
    G14,
    G15, //GPIO6端口 8-15  //快速GPIO端口  对应端口B
    G16,
    G17,
    G18,
    G19,
    ...
    G21,
    G22,
    G23, //GPIO6端口 16-23 //快速GPIO端口  对应端口B
    G24,
    G25,
    G26,
    G27,
    ...
    G29,
    G30,
    G31, //GPIO6端口 24-31 //快速GPIO端口  对应端口B
    ...
    H13,
    H14,
    H15, //GPIO7端口 8-15  //快速GPIO端口  对应端口C
    H16,
    H17,
    H18,
    H19,
    ...
    H21,
    H22,
    H23, //GPIO7端口 16-23 //快速GPIO端口  对应端口C
    H24,
    H25,
    H26,
    H27,
    ...
    H29,
    H30,
    H31, //GPIO7端口 24-31 //快速GPIO端口  对应端口C
    ...
    I13,
    I14,
    I15, //GPIO8端口 8-15  //快速GPIO端口  对应端口D
    I16,
    I17,
    I18,
    I19,
    ...
    I21,
    I22,
    I23, //GPIO8端口 16-23 //快速GPIO端口  对应端口D
    I24,
    I25,
    I26,
    I27,
    ...
    I29,
    I30,
    I31, //GPIO8端口 24-31 //快速GPIO端口  对应端口D
} PIN_enum;
