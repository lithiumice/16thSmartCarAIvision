...
void fork_road_judge()
{
    ...
    if (
        (f2.fork_L_flag == 1 &&
         ...
         is_L_R_lose(MIN(fork_L_lose_row, fork_R_lose_row), f2.toppoint, 2, 95)) ||

        (abs(((f2.fork_R_col + f2.fork_L_col) / 2) - f2.fork_up_col) <= 8 &&
         f2.fork_up_flag == 1 &&
         f2.fork_L_flag == 1 &&
         f2.fork_R_flag == 1 &&
        ...
        (f2.fork_up_flag == 1 &&
         ...
         abs((f2.fork_up_line[f2.fork_up_col - 15] - f2.fork_up_line[f2.fork_up_col]) -
             (f2.fork_up_line[f2.fork_up_col + 15] - f2.fork_up_line[f2.fork_up_col])) < 8 &&
         is_straight_line(f2.fork_up_col - 30, f2.fork_up_col, f2.fork_up_line, 5) &&
         is_straight_line(f2.fork_up_col, f2.fork_up_col + 30, f2.fork_up_line, 5) &&
        ...
        (f2.fork_L_flag == 0 &&
         ...
         is_straight_line(5, f2.fork_up_col, f2.fork_up_line, 8) &&

         f2.fork_up_line[10] > 30 &&
         f2.fork_up_line[10] < 80 &&
        ...
        (f2.fork_L_flag == 1 &&
         ...
         is_straight_line(f2.fork_up_col, 155, f2.fork_up_line, 8) &&

         f2.fork_up_line[150] > 30 &&
